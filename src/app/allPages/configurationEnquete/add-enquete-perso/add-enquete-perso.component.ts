...
@Component({
  selector: 'app-add-enquete-perso',
  templateUrl: './add-enquete-perso.component.html',
  styleUrls: ['./add-enquete-perso.component.css'],
  animations:[fadefromright]
})
export class AddEnquetePersoComponent implements OnInit {
