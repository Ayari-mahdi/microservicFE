...
@Component({
  selector: 'app-add-enquete-qvt',
  templateUrl: './add-enquete-qvt.component.html',
  styleUrls: ['./add-enquete-qvt.component.css'],
  animations:[fadefromright]
})
export class AddEnqueteQVTComponent implements OnInit {
previous=false;
last=false;
formclass1="current"
formclass2="pending"
